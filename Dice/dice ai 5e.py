...
dataset = pd.read_csv('count_differences1.csv')

# Prepare the training data
X_features = dataset[['is_counts_equal', 'num_dice', 'num_sides', 'count_difference', 'num_zeros']].values
...
input_num_zeros = 7140

# Prepare the input data
X_input = np.array([[input_is_counts_equal, input_num_dice, input_num_sides, input_count_difference, input_num_zeros]])
